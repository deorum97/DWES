    ...
    <?php foreach (($datos['articulos'] ?? []) as $c): ?>
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo RUTA_URL; ?>/articulos/borrar/<?php echo $c['id_articulo']; ?>"
                   onclick="return confirm('¿Seguro?')">Borrar</a>
                <a href="<?php echo rtrim(RUTA_URL,'/'); ?>/articulos/editar/<?php echo (int)($c['id_articulo'] ?? 0); ?>">Editar</a>
...
<a href="<?php echo RUTA_URL; ?>/articulos/nuevo">Añadir Nuevo Artículo</a>
